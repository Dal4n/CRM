...
const AppMenu = () => {
    ...
    const model: AppMenuItem[] = [
        {
            label: 'Analitica',
            items: [/* { label: '2', icon: 'pi pi-fw pi-home', to: '/' },
                { label: 'Chart', icon: 'pi pi-fw pi-chart-bar', to: '/uikit/charts' }, */
                { label: 'Dashboard', icon: 'pi pi-fw pi-chart-bar', to: '/components/analitica' },
            ]
        },
        {
            label: 'Marketing',
        ...
        },
        {
            ...
            items: [
                ...
                { label: 'Ventas de Membresias', icon: 'pi pi-fw pi-id-card', to: '/components/historicoVentasMembresias' },
            ]
        },
        {
            label: 'Clientes',
            items: [
                ...
                { label: 'Clientes Proospectos', icon: 'pi pi-fw pi-book', to: '/components/ebook' },
                { label: 'Membresias', icon: 'pi pi-fw pi-credit-card', to: '/components/trakeoMembresia' },
            ]
        },
        {
            label: 'Ratings',
